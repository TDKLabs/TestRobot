...
<con:soapui-settings xmlns:con="http://eviware.com/soapui/config">
	...
	<con:setting id="WebRecordingSettings@excluded-headers">
		<![CDATA[<xml-fragment>
			<con:entry xmlns:con="http://eviware.com/soapui/config">Cookie</con:entry>
			<con:entry xmlns:con="http://eviware.com/soapui/config">Set-Cookie</con:entry>
			<con:entry xmlns:con="http://eviware.com/soapui/config">Referer</con:entry>
			<con:entry xmlns:con="http://eviware.com/soapui/config">Keep-Alive</con:entry>
			<con:entry xmlns:con="http://eviware.com/soapui/config">Connection</con:entry>
			<con:entry xmlns:con="http://eviware.com/soapui/config">Proxy-Connection</con:entry>
			<con:entry xmlns:con="http://eviware.com/soapui/config">Pragma</con:entry>
			<con:entry xmlns:con="http://eviware.com/soapui/config">Cache-Control</con:entry>
			<con:entry xmlns:con="http://eviware.com/soapui/config">Transfer-Encoding</con:entry>
			<con:entry xmlns:con="http://eviware.com/soapui/config">Date</con:entry>
	...
	<con:setting id="UISettings@show_startup_page">true</con:setting>
	...
	<con:setting id="WSISettings@location">@@WSISETTINGSLOCATION@@</con:setting>
	...
	<con:setting id="ProxySettings@host"/>
	<con:setting id="ProxySettings@port"/>
	...
	<con:setting id="SSLSettings@keyStore">@@SSLSETTINGSKEYSTORE@@</con:setting>
	<con:setting id="SSLSettings@keyStorePassword">@@SSLSETTINGSKEYSTOREPASSWD@@</con:setting>
  ...
  <con:property>
    <con:name>~(?s).*at [a-zA-Z][\w\$]*(\.[a-zA-Z][\w\$]*)+\((Unknown Source|Native Method|[a-zA-Z][\w\$]*\.([a-zA-Z]{3,5}):\d+)\).*</con:name>
    <con:value>[Stacktrace] Can give hackers information about which software or language you are using</con:value>
  </con:property>
  <con:property>
  ...
  <con:property>
    <con:name>~(?s).*at [\w\$]+(\.[\w\$&lt;>\[\],]+|\.\.ctor)+(\((([\w\$&lt;>\`\[\]]+ [\w\$&lt;>]+, )*(([\w\$&lt;>\`\[\]]+ [\w\$&lt;>]+)))\)|\(\)).*</con:name>
    <con:value>[Stacktrace] Can give hackers information about which software or language you are using</con:value>
  </con:property>
  <con:property>
  ...
  <con:property>
    <con:name>~(?s).*((A|a)pache|vBulletin|MySQL|PostgreSQL|phpBB|Internet Information Services)( |/)\d{1,2}(\.\d{1,3})+.*</con:name>
    <con:value>[Version x.y.z] Exposing version numbers gives 
			unnecessary hints on your systems vulnerabilities</con:value>
  </con:property>
  <con:property>
  ...
  <con:property>
    <con:name>~(?s).*(ORA|EXP|IMP|KUP|UDE|UDI|DBV|LCD|QSM|OCI|RMAN|LFI|PLS|PLQ|AMD|CLSR|PROC|PROT|TNS|NNC|NLP|NNF|NMP|NCR|NZE|O2F|O2I|O2U|PCB|PCC|SQL|AUD|IMG|VID|DRG|LPX|LSX)-\d{5}\s.*</con:name>
    <con:value>[Database error messages] Internal database information can be misused by hackers</con:value>
  </con:property>
</xml-fragment>]]></con:setting><con:setting id="RecentProjects"><![CDATA[<xml-fragment xmlns:con="http://eviware.com/soapui/config">
